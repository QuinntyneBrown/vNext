...
{
    public class DashboardTileFavoriteDeleteByDashboardTileIdCommand
    {
        ...
        public class Procedure
        {
            public static async Task<int> ExecuteAsync(Request request, IDbConnection connection)
            {
                ...
                return await connection.ExecuteProcAsync("[Common].[ProcDashboardTileFavoriteDeleteByDashboardTileId]", new { request.DashboardTileId });
